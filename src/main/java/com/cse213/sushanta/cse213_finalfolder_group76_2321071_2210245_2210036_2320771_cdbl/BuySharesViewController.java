...
public class BuySharesViewController {
    ...
    @FXML
    private TableView<BuyShares> buySharesTableView;
    ...
    @FXML
    private TableColumn<BuyShares,Integer> priceTableColumn;

    @FXML
    private TableColumn<BuyShares,Integer> sharesTableColumn;
